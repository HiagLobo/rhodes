...
// `ConclusaoInvalidaError`, `maisTarde`, `proximaAncoraFixed` foram movidos para instancias.ts
// (Onda 07/S4) — a reancoragem e a projeção do calendário reusam; aqui só re-exportamos o erro
// para não quebrar os imports das rotas/testes.
export { ConclusaoInvalidaError };
